## Решение 1 задания:
### a) Stars - файл Main.java (YLabJavaIntensive/YLabTask1/src/stars) 
...
### b) Pell - файл Main.java (YLabJavaIntensive/YLabTask1/src/pell) 
...
### c) MultTable - файл Main.java (YLabJavaIntensive/YLabTask1/src/mult_table) 
...
### d) Guess - файл Main.java (YLabJavaIntensive/YLabTask1/src/guess) 
